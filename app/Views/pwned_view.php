...
<body>
    ...
    <div id="statusPopup" class="popup-overlay">
        <div class="popup-box" id="popupBox">
            <h1 class="title-pwned" id="popupTitle" style="font-size: 32px; margin-bottom: 20px;">PWNED!</h1>
            <p id="popupDesc" style="font-size: 10px; line-height: 1.8; margin-bottom: 30px;">
                Oh no! We found your email in several data breaches.
            </p>
            <div style="display: flex; justify-content: center; gap: 15px;">
                <button class="btn-check btn-popup-close" onclick="tutupPopup()">Close</button>
                <button class="btn-check btn-popup-show" id="btnShowMore" onclick="showMore()">SHOW MORE</button>
            </div>
        </div>
    </div>
        ...
        <div class="main-container">
            <div id="part-analysis">
                ...
                <div class="grid-3">
                    ...
                    <div class="card alert" id="cardStatus">
...
<script>
    ...
    function processCheck(event) {
        ...
        if (foundData && foundData.status === "tidak_aman") {
            ...
            popupBox.style.borderColor = "#cc0000"; 
            popupTitle.innerText = "PWNED!";
            popupTitle.style.color = "#cc0000";
            popupDesc.innerText = "Oh no! We found your email in several data breaches.";
            ...
            popupBox.style.borderColor = "#00ff00"; 
            popupTitle.innerText = "SAFE!";
            popupTitle.style.color = "#00ff00";
            popupDesc.innerText = "Good news! We couldn't find your email in any public data breaches.";
